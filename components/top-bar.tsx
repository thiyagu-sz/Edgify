 ...
 * `#appHeader` (docs/reference/trellis-prototype.html). Server Component (static; no state).
 *
...
export function TopBar() {
  return (
    <header className="topbar">
      <Link href="/" className="brand" aria-label="Trellis — home">
        ...
        <span className="word">trellis</span>
      </Link>
