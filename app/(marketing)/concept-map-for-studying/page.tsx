      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: serialiseJsonLd(
            breadcrumbJsonLd(env.SITE_URL, "Concept Map for Studying", "/concept-map-for-studying"),
          ),
        }}
      />
      ...
      <div className="lx-wrap">
        ...
        <section className="lx-section">
          <div className="lx-shead">
            ...
            <div className="line" />
            <h2 className="lx-h2">A map that shows direction, not just topics</h2>
          </div>
